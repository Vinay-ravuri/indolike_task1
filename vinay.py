...
test_data=pd.read_csv(r"task1/test_data_solution.txt",sep=':::',engine='python')
test_data_solution=pd.read_csv(r"task1/test_data_solution.txt",sep=':::',engine='python')
train_data=pd.read_csv(r"task1/train_data.txt",sep=":::",engine='python')
